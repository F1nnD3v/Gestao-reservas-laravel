...
@section('title', 'Gerir casas')
@section('content')
    <link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-beta.3/css/bootstrap.css" rel="stylesheet">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-beta.3/js/bootstrap.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.0/jquery.js"></script>
    <a href="{{url('/AdicionarCasa')}}" class="justify-content-end" style="margin-left: 78.6rem">
        <button class="btn btn-primary justify-content-end">Adicionar casa</button>
    </a>
    <style>
        body {
    ...
    <div class="form">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active">Gerir casas</a>
            </li>
            <li class="nav-item">
